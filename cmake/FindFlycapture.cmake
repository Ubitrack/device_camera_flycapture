...
set(LIB_PATH_SUFFIX "")
set(FLYCAPTURE_MSVC_VERSION "")
if(MSVC)
  if(${MSVC_VERSION} GREATER_EQUAL 1910 AND ${MSVC_VERSION} LESS_EQUAL 1919)
    set(FLYCAPTURE_MSVC_VERSION "140")
    set(LIB_PATH_SUFFIX "vs2015")
  elseif(${MSVC_VERSION} EQUAL 1900)
    set(FLYCAPTURE_MSVC_VERSION "140")
    set(LIB_PATH_SUFFIX "vs2015")
  elseif(${MSVC_VERSION} EQUAL 1800)
    set(FLYCAPTURE_MSVC_VERSION "120")
    set(LIB_PATH_SUFFIX "vs2013")
  elseif(${MSVC_VERSION} EQUAL 1700)
    set(FLYCAPTURE_MSVC_VERSION "110")
  elseif(${MSVC_VERSION} EQUAL 1600)
    set(FLYCAPTURE_MSVC_VERSION "100")
  else()
...
MESSAGE(STATUS "Looking for Flycapture Library Names: ${FLYCAPTURE_LIBRARY_NAMES}")

FIND_LIBRARY(FLYCAPTURE_LIBRARY NAMES ${FLYCAPTURE_LIBRARY_NAMES} PATH_SUFFIXES ${LIB_PATH_SUFFIX} HINTS ${FLYCAPTURE_TEST_LIB_PATHS})
